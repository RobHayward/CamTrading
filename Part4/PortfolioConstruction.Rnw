...
\item US stocks (SPY)
\item US bonds (TLT)
\item EEM MSCI emerging markets
\item GLD Gold index
\item EWJ MSCI Japan 
\item XLK Technology sector
\item LQD Investment grade corporate bond
\item RSP Equal-weight S\&P 500
\item USO US oil
\item BOND Pimco active bond investment
\begin{table}
\begin{center}
